...
class Util(abc.ABC):  # Abstract class
    def _init_params(self):
        ...
        self._accepted_params_docs = dict()
        self._accepted_params_docs['use_random_orthogonalization'] = 'Usa Ortogonalização na hora de gerar pesos. Deve ser True ou False*'
        self._accepted_params_docs['seed'] = 'A semente aleatória utilizada pelo método. Deixe o software cuidar dessa variável.'
